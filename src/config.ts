...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    author: 'thiagocolman',
    // site url
    url: 'https://www.thiagocolman.com', // e.g., https://example.com
    // base path
  ...
  color: {
    ...
    dark: {
      ...
      background: '#121212',
      // highlight color
      highlight: 'rgb(229 231 235 / 0.12)',
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/thiagohenriquesantos',
      },
      {
        name: 'Email',
        url: 'thiagosantosdev@gmail.com',
      },
      {
        name: 'X',
